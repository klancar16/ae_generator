import pandas as pd
from preprocessing import preprocess, fill_missing
...
datasets = data_read.datasets_reg
i = 0
n = 5
...
for dataset in datasets:
    for j in range(n):
        ...
        for train_index, test_index in kf.split(preprocessed_data):
            ...
            class_sc = evaluation.regression(pr_dat_train, new_data, pr_dat_test, class_column=class_column)
            results['vae']['classification']['m1d1'] += class_sc[0]
            results['vae']['classification']['m2d1'] += class_sc[1]
            ###
            ...
            class_sc = evaluation.regression(pr_dat_train, new_data_2, pr_dat_test, class_column=class_column)
            results['ae']['classification']['m1d1'] += class_sc[0]
            results['ae']['classification']['m2d1'] += class_sc[1]
            ###
            K.clear_session()
